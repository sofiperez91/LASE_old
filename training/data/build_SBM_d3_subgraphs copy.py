...
with open('./data/sbm3_unbalanced_positive_original_graph_095.pkl', 'wb') as f:
...
with open('./data/sbm3_unbalanced_positive_train_subgraphs_095.pkl', 'wb') as f:
    pickle.dump(train_data, f)
    
with open('./data/sbm3_unbalanced_positive_val_subgraphs_095.pkl', 'wb') as f:
